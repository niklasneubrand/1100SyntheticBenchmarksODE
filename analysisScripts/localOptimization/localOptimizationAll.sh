...
nohup matlab-R2021a -r "localOptimizationMulti('$fast2_dir', 'normal'); exit;" > $log_file_fast2 2>&1 &
nohup matlab-R2021a -r "localOptimizationMulti('$slow2_dir', 'normal'); exit;" > $log_file_slow2 2>&1 &