function [simuSuccess, lastConfig, errReport] = arSimuMultiTries(sensi, fine, dynamics, options)
    ...
    try
        ...
        if iTry < nCVRestart
            ...
            elseif toggleVectorTols == 2
                ...
                toggleVectorTols = 3;  % only show console output once
            end
            if increaseMaxsteps
